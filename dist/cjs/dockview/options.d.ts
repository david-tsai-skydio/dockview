...
export type BuiltInContextMenuItem = 'close' | 'closeOthers' | 'closeAll' | 'closeLeft' | 'closeRight' | 'maximize' | 'float' | 'popout' | 'separator' | 'pin';
export type BuiltInChipContextMenuItem = 'separator' | 'colorPicker' | 'rename' | 'collapse' | 'close';
...
export interface IContextMenuItemRenderer extends IDisposable {
    readonly element: HTMLElement;
    init(props: IContextMenuItemComponentProps | IChipContextMenuItemComponentProps): void;
}
 ...
 */
export declare const OVERFLOW_WRAP_TABS_CLASS = "dv-tabs-container--wrap";
/**
 ...
 */
export declare const OVERFLOW_WRAP_TABS_CAPPED_CLASS = "dv-tabs-container--wrap-capped";
/**
 ...
 */
export declare const OVERFLOW_MAX_TAB_ROWS_VARIABLE = "--dv-max-tab-rows";
/**
 ...
 */
export declare const OVERFLOW_WRAP_TABS_VERTICAL_TAB_HEIGHT_VARIABLE = "--dv-wrap-vertical-tab-height";
/**
 ...
 * edge is off).
 */
export type EdgeGroupSet = boolean | Partial<Record<EdgeGroupPosition, boolean>>;
/** Whether `position` is enabled in a per-edge {@link EdgeGroupSet}. */
export declare function isEdgeGroupEnabled(set: EdgeGroupSet | undefined, position: EdgeGroupPosition): boolean;
/** Whether any edge is enabled in a per-edge {@link EdgeGroupSet}. */
export declare function isAnyEdgeGroupEnabled(set: EdgeGroupSet | undefined): boolean;
